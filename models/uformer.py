...
class PnPNystraAttention(nn.Module):
    def __init__(self, num_landmarks, iters, dim, win_size,num_heads, token_projection='linear', qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, attention_mechanism, num_landmarks, iters, dim, input_resolution, num_heads, win_size=8, shift_size=0,
        ...
        if attention_mechanism == 'original':
            ...
            self.attn = PnPNystraAttention(num_landmarks, iters,
                dim, win_size=to_2tuple(self.win_size), num_heads=num_heads,
                qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=drop,
                token_projection=token_projection)
...
class BasicUformerLayer(nn.Module):
    def __init__(self, attention_mechanism, num_landmarks, iters, dim, output_dim, input_resolution, depth, num_heads, win_size,
        ...
        if shift_flag:
            self.blocks = nn.ModuleList([
                LeWinTransformerBlock(attention_mechanism, num_landmarks, iters, dim=dim, input_resolution=input_resolution,
...
class Uformer(nn.Module):
    def __init__(self, attention_mechanism, num_landmarks, iters, img_size=256, in_chans=3, dd_in=3,
        ...
        # Encoder
        self.encoderlayer_0 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim,
        ...
        self.encoderlayer_1 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*2,
        ...
        self.encoderlayer_2 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*4,
        ...
        self.encoderlayer_3 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*8,
        ...
        # Bottleneck
        self.conv = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*16,
        ...
        self.decoderlayer_0 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*16,
                            output_dim=embed_dim*16,
                            input_resolution=(img_size // (2 ** 3),
                                                img_size // (2 ** 3)),
                            depth=depths[5],
        ...
        self.decoderlayer_1 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*8,
                            output_dim=embed_dim*8,
                            input_resolution=(img_size // (2 ** 2),
                                                img_size // (2 ** 2)),
                            depth=depths[6],
        ...
        self.decoderlayer_2 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*4,
                            output_dim=embed_dim*4,
                            input_resolution=(img_size // 2,
                                                img_size // 2),
                            depth=depths[7],
        ...
        self.decoderlayer_3 = BasicUformerLayer(attention_mechanism, num_landmarks, iters, dim=embed_dim*2,
                            output_dim=embed_dim*2,
                            input_resolution=(img_size,
                                                img_size),
                            depth=depths[8],
    ...
    def forward(self, x, mask=None):
        ...
        out1 = x + y if self.dd_in ==3 else y
        return out1
...
if __name__ == "__main__":
    ...
    model_restoration = Uformer(img_size=input_size, embed_dim=16,depths=depths,
                 win_size=32, mlp_ratio=4., token_projection='linear', token_mlp='leff', modulator=True, shift_flag=False)
